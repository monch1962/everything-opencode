...
const { getOpencodeDir, ensureDir, readFile, writeFile } = require('../lib/utils');
      ...
      properties: {
        ...
        python: {
          ...
          properties: {
            projectType: {
              type: 'string',
              enum: ['fastapi', 'django', 'flask', 'data-science', 'machine-learning', 'cli', 'library', 'unknown']
            },
            dependencyManager: {
              type: 'string',
