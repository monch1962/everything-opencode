...
Thanks for wanting to contribute. This repo is meant to be a community resource for opencode users.
...
Make sure your config works with opencode before submitting.
